<?php
echo $session=$this->session->userdata('admin_session');
?>
    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a hef="home.html"><img src="html/image/logo2.png" height="150" width="100" alt="fotodio_logo" class="hidden-xs hidden-sm">
                        <img src="html/image/logo2.png" alt="fotodio logo" class="visible-xs visible-sm circle-logo">
                    </a>
                </div>
                <div class="navi">
                    <ul>
                        <li class="active"><a href="#"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Home</span></a></li>
                        <li><a href="<?php echo site_url('Make_offer'); ?>"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Make Offer</span></a></li>
